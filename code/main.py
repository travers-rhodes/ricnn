...
tf_valid_dataset = tf.constant(mnist.valid.images)
valid_labels = mnist.valid.labels
...
for i in range(30000):
    ...
    if not i % 1000:
        ls = sess.run([loss], feed_dict = {X_in: batch.images, Y: batch.labels, keep_prob: 1.0})
